...
import cardBack from "../../../assets/img/core-team/card-back.png";
...
function MembersSection() {
          ...
          <div class="card">
              <div class="card-inner">
                  <div class="card-front">
                      ...
                      <img src=${img1} class="card-img-top" alt="${data[x].title}">
  ...
  return (
    <div
      id="execomDiv"
      className="fw-100 text-center d-flex flex-row justify-content-around align-items-center flex-wrap"
    ></div>
  );
}
